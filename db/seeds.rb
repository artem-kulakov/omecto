...
# Event.create([
# 	{ title: 'Birthday', description: description, city: 'Moscow', address: 'Red Square', date: '2019-06-30 07:10:00', categories: 'a,b', image: '/images/city1.jpg', user_id: 1 },
# 	{ title: 'PHP Beer', description: description, city: 'London', address: 'Trafalgar Square', date: '2019-06-30 07:10:00', categories: 'b,c', image: '/images/city2.jpg', user_id: 1 },
# 	{ title: 'Soccer', description: description, city: 'Berlin', address: 'Alexander Platz', date: '2019-06-30 07:10:00', categories: 'c,d', image: '/images/city3.jpg', user_id: 1 },
# 	{ title: 'Financial modelling', description: description, city: 'Palo Alto', address: 'Lenin Street', date: '2019-06-30 07:10:00', categories: 'd,e', image: '/images/city4.jpg', user_id: 1 },
# 	{ title: 'Rails Party', description: description, city: 'Madrid', address: 'Some Street', date: '2019-06-30 07:10:00', categories: 'e,f', image: '/images/city5.jpg', user_id: 1 },
# 	{ title: 'History Club', description: description, city: 'Berlin', address: 'Alexander Platz', date: '2019-06-30 07:10:00', categories: 'f,g', image: '/images/city6.jpg', user_id: 1 },
# ])
