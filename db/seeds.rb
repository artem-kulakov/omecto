...
# Event.create([
# 	{ title: 'Birthday', description: description, city: 'Moscow', address: 'Red Square', date: '2019-06-30 07:10:00', categories: '1,2', image: '/images/city1.jpg', user_id: 1 },
# 	{ title: 'PHP Beer', description: description, city: 'London', address: 'Trafalgar Square', date: '2019-06-30 07:10:00', categories: '2,3', image: '/images/city2.jpg', user_id: 1 },
# 	{ title: 'Soccer', description: description, city: 'Berlin', address: 'Alexander Platz', date: '2019-06-30 07:10:00', categories: '3,4', image: '/images/city3.jpg', user_id: 1 },
# 	{ title: 'Financial modelling', description: description, city: 'Palo Alto', address: 'Lenin Street', date: '2019-06-30 07:10:00', categories: '4,5', image: '/images/city4.jpg', user_id: 1 },
# 	{ title: 'Rails Party', description: description, city: 'Madrid', address: 'Some Street', date: '2019-06-30 07:10:00', categories: '5,6', image: '/images/city5.jpg', user_id: 1 },
# 	{ title: 'History Club', description: description, city: 'Berlin', address: 'Alexander Platz', date: '2019-06-30 07:10:00', categories: '6,7', image: '/images/city6.jpg', user_id: 1 },
# ])
...
Category.create([
  { title: 'Food & Drinks', icon: '/images/event-icon1.png', image: '/images/c-img1.png', cat_id: 1 },
  { title: 'Night Life', icon: '/images/event-icon2.png', image: '/images/c-img2.png', cat_id: 2 },
  { title: 'Outdoors & Adventure', icon: '/images/event-icon3.png', image: '/images/c-img3.png', cat_id: 3 },
  { title: 'Tech', icon: '/images/event-icon4.png', image: '/images/c-img4.jpg', cat_id: 4 },
  { title: 'Self Improvement', icon: '/images/event-icon5.png', image: '/images/c-img5.jpg', cat_id: 5 },
  { title: 'Sports', icon: '/images/event-icon6.png', image: '/images/c-img6.jpg', cat_id: 6 },
  { title: 'Learning', icon: '/images/event-icon7.png', image: '/images/c-img7.jpg', cat_id: 7 },
  { title: 'Travel', icon: '/images/event-icon8.png', image: '/images/c-img9.jpg', cat_id: 8 },
  { title: 'Music & Dance', icon: '/images/event-icon9.png', image: '/images/c-img10.jpg', cat_id: 9 },
  { title: 'Single\'s Only', icon: '/images/event-icon10.png', image: '/images/c-img11.jpg', cat_id: 10 },
  { title: 'Family', icon: '/images/event-icon11.png', image: '/images/c-img12.jpg', cat_id: 11 },
  { title: 'Health & Wellness', icon: '/images/event-icon12.png', image: '/images/c-img13.jpg', cat_id: 12 },
  { title: 'Hobbies & Crafts', icon: '/images/event-icon13.png', image: '/images/c-img14.jpg', cat_id: 13 },
  { title: 'Fashion & Beauty', icon: '/images/event-icon14.png', image: '/images/c-img15.jpg', cat_id: 14 },
  { title: 'Film', icon: '/images/event-icon15.png', image: '/images/c-img16.jpg', cat_id: 15 },
  { title: 'Beliefs', icon: '/images/event-icon16.png', image: '/images/c-img17.jpg', cat_id: 16 },
  { title: 'LGBTQ', icon: '/images/event-icon17.png', image: '/images/c-img18.jpg', cat_id: 17 },
  { title: 'Language & Culture', icon: '/images/event-icon18.png', image: '/images/c-img19.jpg', cat_id: 18 },
  { title: 'Photography', icon: '/images/event-icon19.png', image: '/images/c-img20.jpg', cat_id: 19 },
  { title: 'Book Club', icon: '/images/event-icon20.png', image: '/images/c-img21.jpg', cat_id: 20 },
  { title: 'Pets', icon: '/images/event-icon21.png', image: '/images/c-img22.jpg', cat_id: 21 },
  { title: 'Arts', icon: '/images/event-icon22.png', image: '/images/c-img23.jpg', cat_id: 22 },
  { title: 'Seminar & Talks', icon: '/images/event-icon23.png', image: '/images/c-img24.jpg', cat_id: 23 },
  { title: 'Freelance Community', icon: '/images/event-icon24.png', image: '/images/c-img8.jpg', cat_id: 24 },
])
