...
Event.create([
               { title: 'Birthday', description: description, address: 'Red Square', date: '2019-06-30 07:10:00', user_id: 1, location_id: 1 },
               { title: 'PHP Beer', description: description, address: 'Trafalgar Square', date: '2019-06-30 07:10:00', user_id: 2, location_id: 2 },
               { title: 'Soccer', description: description, address: 'Alexander Platz', date: '2019-06-30 07:10:00', user_id: 3, location_id: 3 },
               { title: 'Financial modelling', description: description, address: 'Lenin Street', date: '2019-06-30 07:10:00', user_id: 4, location_id: 4 },
               { title: 'Rails Party', description: description, address: 'Some Street', date: '2019-06-30 07:10:00', user_id: 5, location_id: 5 },
               { title: 'History Club', description: description, address: 'Alexander Platz', date: '2019-06-30 07:10:00', user_id: 6, location_id: 6 }
             ])
...
Category.create([
  { title: 'Food & Drinks', icon: '/images/event-icon1.png', image: '/images/c-img1.png'},
  { title: 'Night Life', icon: '/images/event-icon2.png', image: '/images/c-img2.png'},
  { title: 'Outdoors & Adventure', icon: '/images/event-icon3.png', image: '/images/c-img3.png'},
  { title: 'Tech', icon: '/images/event-icon4.png', image: '/images/c-img4.jpg'},
  { title: 'Self Improvement', icon: '/images/event-icon5.png', image: '/images/c-img5.jpg'},
  { title: 'Sports', icon: '/images/event-icon6.png', image: '/images/c-img6.jpg'},
  { title: 'Learning', icon: '/images/event-icon7.png', image: '/images/c-img7.jpg'},
  { title: 'Travel', icon: '/images/event-icon8.png', image: '/images/c-img9.jpg'},
  { title: 'Music & Dance', icon: '/images/event-icon9.png', image: '/images/c-img10.jpg'},
  { title: 'Single\'s Only', icon: '/images/event-icon10.png', image: '/images/c-img11.jpg'},
  { title: 'Family', icon: '/images/event-icon11.png', image: '/images/c-img12.jpg'},
  { title: 'Health & Wellness', icon: '/images/event-icon12.png', image: '/images/c-img13.jpg'},
  { title: 'Hobbies & Crafts', icon: '/images/event-icon13.png', image: '/images/c-img14.jpg'},
  { title: 'Fashion & Beauty', icon: '/images/event-icon14.png', image: '/images/c-img15.jpg'},
  { title: 'Film', icon: '/images/event-icon15.png', image: '/images/c-img16.jpg'},
  { title: 'Beliefs', icon: '/images/event-icon16.png', image: '/images/c-img17.jpg'},
  { title: 'LGBTQ', icon: '/images/event-icon17.png', image: '/images/c-img18.jpg'},
  { title: 'Language & Culture', icon: '/images/event-icon18.png', image: '/images/c-img19.jpg'},
  { title: 'Photography', icon: '/images/event-icon19.png', image: '/images/c-img20.jpg'},
  { title: 'Book Club', icon: '/images/event-icon20.png', image: '/images/c-img21.jpg'},
  { title: 'Pets', icon: '/images/event-icon21.png', image: '/images/c-img22.jpg'},
  { title: 'Arts', icon: '/images/event-icon22.png', image: '/images/c-img23.jpg'},
  { title: 'Seminar & Talks', icon: '/images/event-icon23.png', image: '/images/c-img24.jpg'},
  { title: 'Freelance Community', icon: '/images/event-icon24.png', image: '/images/c-img8.jpg'},
])
